 ...
 */
class getVichUploader_Listener_Remove_ProfilePicService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.profilePic' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.profilePic'])) {
            return $container->privates['vich_uploader.listener.remove.profilePic'];
        }

        return $container->privates['vich_uploader.listener.remove.profilePic'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('profilePic', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
