...
class getBookRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\BookRepository'])) {
            return $container->privates['App\\Repository\\BookRepository'];
        }

        return $container->privates['App\\Repository\\BookRepository'] = new \App\Repository\BookRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
